...
**ulackroad prism** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
> BlackRoad Prism — operations console, fleet health, tasks, KPIs dashboard.
